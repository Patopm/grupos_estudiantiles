...
class AuditLogAdmin(admin.ModelAdmin):
    ...
    list_display = [
        ...
        'status_indicator', 'message_preview'
    ]
    list_filter = [
    ...
    search_fields = [
        'username', 'ip_address', 'message', 'request_path', 'user_agent'
    ]
    readonly_fields = [
        'id', 'timestamp', 'event_type', 'severity', 'user', 'username',
        'ip_address', 'user_agent', 'session_key', 'request_path',
        'request_method', 'status_code', 'message', 'extra_data_formatted',
    ...
    fields = [
        ...
        'ip_address', 'user_agent', 'session_key', 'request_path',
        'request_method', 'status_code', 'message', 'extra_data_formatted',
        'fingerprint', 'geolocation', 'resolved', 'resolved_by',
    ...
    def status_indicator(self, obj):
        ...
        return format_html(
            ...
            color, icon, obj.get_severity_display(), status
        )
    ...
    def get_readonly_fields(self, request, obj=None):
        ...
        if obj and not obj.resolved:
            ...
            readonly = [f for f in readonly if f not in ['resolved', 'resolved_by', 'resolved_at', 'resolution_notes']]
        return readonly
    ...
    def mark_resolved(self, request, queryset):
        ...
        self.message_user(
            request,
            f'Successfully marked {updated} audit log(s) as resolved.'
        )
