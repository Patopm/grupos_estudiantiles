    ...
    def decorator(func):
        ...
        def wrapper(request, *args, **kwargs):
            try:
                ...
                log_security_event(request, 'rate_limit_exceeded', {
                    'group': group,
                    'rate': rate,
    ...
    def decorator(func):
        ...
        def wrapper(request, *args, **kwargs):
            ...
            try:
                ...
                # Log failed access
                log_security_event(request, f"{current_event_type}_error", {
                    'error': str(e),
    ...
    def wrapper(request, *args, **kwargs):
        ...
        for header in required_headers:
            if not request.META.get(header):
                log_security_event(request, 'missing_required_header', {
