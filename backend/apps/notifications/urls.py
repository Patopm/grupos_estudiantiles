...
router.register(r"emails", EmailNotificationViewSet, basename="email-notifications")
router.register(
    r"preferences", NotificationPreferencesViewSet, basename="notification-preferences"
)
