...
class TOTPDevice(models.Model):
    ...
    def get_provisioning_uri(self):
        ...
        return totp.provisioning_uri(
            ...
            issuer_name='Grupos Estudiantiles - Tecmilenio')
...
class EmailNotification(models.Model):
    ...
    def send(self):
        ...
        try:
            ...
            success = send_mail(subject=self.subject,
                                message=self.text_content
                                or strip_tags(self.html_content),
...
class NotificationPreferences(models.Model):
    ...
    # Group notifications
    group_requests = models.BooleanField(default=True,
                                         verbose_name='Solicitudes de grupo')
    ...
    new_members = models.BooleanField(default=True,
                                      verbose_name='Nuevos miembros')

    # Security notifications
    security_alerts = models.BooleanField(default=True,
                                          verbose_name='Alertas de seguridad')
    ...
    # Timing preferences
    email_frequency = models.CharField(max_length=20,
                                       choices=[
                                           ('immediate', 'Inmediato'),
                                           ('daily', 'Diario'),
                                           ('weekly', 'Semanal'),
