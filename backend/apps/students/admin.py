...
class StudentGroupAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Configuración", {"fields": ("max_members", "image")}),
        ("Liderazgo", {"fields": ("president",)}),
...
class GroupMembershipAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Información de Membresía", {"fields": ("user", "group", "status", "role")}),
        ("Fechas", {"fields": ("joined_at",), "classes": ("collapse",)}),
    )
