      ...
      <div className='max-w-7xl mx-auto p-6'>
        <div className='mb-6'>
          ...
          <p className='text-muted-foreground'>
            Bienvenido a tu dashboard de presidente. Aquí podrás gestionar tu
            grupo y crear eventos.
          </p>
        </div>

        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          <div className='p-6 border rounded-lg'>
            <h3 className='text-xl font-semibold mb-2'>Mi Grupo</h3>
            <p className='text-muted-foreground mb-4'>
              Gestiona tu grupo estudiantil
            </p>
            <Button>Gestionar Grupo</Button>
          </div>
          ...
          <div className='p-6 border rounded-lg'>
            <h3 className='text-xl font-semibold mb-2'>Miembros</h3>
            <p className='text-muted-foreground mb-4'>
          ...
          <div className='p-6 border rounded-lg'>
            ...
            <p className='text-muted-foreground mb-4'>Métricas del grupo</p>
